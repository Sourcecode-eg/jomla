...
abstract class HomeRepo {
  Future<List<CategoryModel>> getAllCategories({int page, int pageSize});
  Future<List<BrandModel>> getAllBrands({int page, int pageSize});
  Future<List<OfferModel>> getAllOffers({int page, int pageSize});
}
